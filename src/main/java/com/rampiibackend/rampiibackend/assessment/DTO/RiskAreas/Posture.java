...
@NoArgsConstructor
@JsonIdentityInfo(scope = com.rampiibackend.rampiibackend.assessment.Entity.RiskAreas.Posture.class,generator= ObjectIdGenerators.PropertyGenerator.class, property="id")
@Data
